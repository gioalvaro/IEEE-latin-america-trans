...
% The paper headers
\markboth{IEEE Latin America Transaction, 6442}%
...
La red de ontolog\'ias propuesta se puede esquematizar mediante la Figura \ref{fig1}, la misma act\'ua como mediador entre los diferentes sistemas industriales. Esto logra que la propuesta abarque un gran espectro de acci\'on sobre distintos dominios de aplicaci\'on y a trav\'es de las etapas del ciclo de vida de producto. Es importante mencionar que, la propuesta sirve no solo para resolver la interoperabilidad entre sistemas que emplean los est\'andares de comit\'e antes mencionado, sino para todos aquellos sistemas que implementen alg\'un tipo de vocabulario, modelo o est\'andar que pueda ser formalizado por una ontolog\'ia en OWL. 
